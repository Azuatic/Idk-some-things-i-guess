...
function Hide()
	Debounce = true
	RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by clicking Right Control", Duration = 7})
...
function RayfieldLibrary:CreateWindow(Settings)
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				if KeyMain.Input.InputBox.Text == Settings.KeySettings.Key then
					...
					if AttemptsRemaining == 0 then
						...
						TweenService:Create(KeyMain.Hide, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
						wait(0.45)
						game.Players.LocalPlayer:Kick("Failed all key attempts.")
					end
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			Dropdown.List.Size = UDim2.new(0, Dropdown.List.Size.X.Offset, 0, 180)
			...
			Dropdown.Interact.MouseButton1Click:Connect(function()
				...
				if Dropdown.List.Visible then
					...
					TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(1, -10, 0, 220)}):Play()
