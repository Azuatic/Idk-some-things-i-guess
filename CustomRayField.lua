...
LoadingFrame.Version.Text = "Version "..getgenv().version or "nil"
...
function ChangeTheme(ThemeName)
	...
	Rayfield.Main.Topbar.Theme:Destroy()
...
function RayfieldLibrary:CreateWindow(Settings)
	TopList.Visible = true Elements.Size = UDim2.new(1, 0, 0, 364) Elements.Position = UDim2.new(0.5, 0, 0.5, 45) Topbar.Type.Visible = false Topbar.Title.Position = UDim2.new(0, 15, 0.5, 0) else TopList.Visible = false Elements.Size = UDim2.new(1, 0,0, 409) Elements.Position = UDim2.new(0.5, 0, 0.555, 0) end
