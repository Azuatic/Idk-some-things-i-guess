...
finity.theme = { -- light
	...
	category_button_background = Color3.fromRGB(219, 220, 228),
...
function finity.new(isdark, gprojectName, thinProject)
	...
	elseif isdark == "custom" then
		theme = finity.custom_theme
	end
